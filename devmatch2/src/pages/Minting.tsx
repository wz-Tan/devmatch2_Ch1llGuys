...
const Minting = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800 text-white py-2 px-4">
            <Container size="2" className="max-w-2xl mx-auto">
                <div className="flex flex-col space-y-8">
                    <Heading
                        size="8"
                        align="center"
                        className="text-4xl font-bold text-transparent bg-clip-text bg-[linear-gradient(45deg,_#00f5ff,_#ff00e0)]"
                    >
                        Mint Your NFT
                    </Heading>
                    ...
                    <div className="space-y-6 bg-gray-800/60 p-8 rounded-xl shadow-lg border border-gray-700 backdrop-blur-sm">
                        ...
                        <Text className="text-lg font-medium text-gray-300">Preview</Text>

...
const ListingPopup = ({ isOpen, onClose, createListing, userNFTs }: { isOpen: boolean, onClose: any, createListing:any, userNFTs: any[] }) => {
  ...
  const handleNFTSelect = (nftId: string) => {
    ...
    console.log("Currently Selected" , selectedNFT)
  };
  ...
  const handleSubmitListing = () => {
    ...
    createListing(listingData.nftId.id, listingData.price);
